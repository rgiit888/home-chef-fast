      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {steps.map((step, index) => (
            <div key={index} className="card-feature text-center group">
              ...
              <p className="text-lg font-medium text-primary mb-2">{step.description}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl group">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              ...
              <p className="text-lg">Fresh ingredients, professional equipment, certified hygiene standards</p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl group">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              ...
              <p className="text-lg">Restaurant-quality dining experience in your own home</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4">Ready to Experience Qckily?</h3>
            <p className="text-muted-foreground mb-6">Join thousands of families already enjoying stress-free, restaurant-quality meals at home</p>
