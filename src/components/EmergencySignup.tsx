...
const EmergencySignup = () => {
  ...
  return (
    <section
      id="emergency-signup"
      className="py-16 bg-gradient-to-br from-destructive/10 to-destructive/5"
    >
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Join Our Early Exclusive Community of{" "}
            <span className="text-primary">100 Families!</span>
          </h2>
          ...
          <p className="text-lg mb-8">
            Get{" "}
            <span className="text-secondary font-semibold">2 Weeks FREE</span> +
            Priority Access!
          </p>
          ...
          <div className="mt-4 bg-secondary/20 rounded-lg p-4 max-w-md mx-auto">
            ...
            <div className="font-semibold">2 minutes ago from Noida</div>
          </div>
        </div>
      </div>
    </section>
