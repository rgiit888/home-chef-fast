        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              From <span className="text-primary">IIT</span> to Your{" "}
              <span className="text-secondary">Home Kitchen</span>
            </h2>
          </div>
            ...
            <div className="text-left space-y-6">
              <p className="text-lg leading-relaxed">
                ...
                <span className="font-semibold text-primary">
                  IIT Bombay/Delhi alumni
                </span>
                , we survived years of questionable restaurant food and
                unreliable home cooks. We knew there had to be a better way.
              </p>

              <p className="text-lg leading-relaxed">
                <span className="font-semibold text-secondary">
                  Qckily is our mission
                </span>{" "}
                to revolutionize Indian home dining - making it seamless and
                hyper-convenient to eat healthy, restaurant-quality food without
                the hassle.
              </p>

              <p className="text-lg leading-relaxed">
                We're not just building a food service. We're creating a{" "}
                <span className="font-semibold text-primary">
                  trust ecosystem
                </span>{" "}
                where technology meets tradition, bringing professional chefs
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Identified gaps in home dining solutions{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        5+ months studying Indian food habits and chef training
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Bringing restaurant-quality cooking to your kitchen
                      </div>
                    </div>
                  </div>
                </div>
